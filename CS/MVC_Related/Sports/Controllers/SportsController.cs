...
namespace Sports.Controllers
{
    public class SportsController : Controller
    {
        ...
        {
            return View("Index", await _context.Sport.Where(s=>s.Sports.Contains(SearchPhrase)).ToListAsync());
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Sports,Team,Player")] Sport sport)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Sports,Team,Player")] Sport sport)
        {
            if (id != sport.Id)
            {
                return NotFound();
